...
public class Image_Mnist_Dl4j {

	public static void main(String args[]) throws Exception{
		Image_Mnist_Dl4j obj = new Image_Mnist_Dl4j();
		obj.skip();
	...
	public void runWekadl4j_mnist() throws Exception{
		...
		// Load the arff file
		Instances data = new Instances(new FileReader(MoreWekaCommon.imgPath + "\\Mnist\\mnist.meta.minimal.arff"));
		...
		imgIter.setImagesLocation(new File(MoreWekaCommon.imgPath + "\\Mnist"));
